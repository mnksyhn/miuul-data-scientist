...
df = pd.read_csv("C:/Users/team/OneDrive/Masaüstü/miuul/data_scientist_bootcamp/5-feature engineering/HWW5tMTkG1za0XcrNuwZ_Kurs Materyalleri(Özellik Mühendisliği)/Kurs Materyalleri(Özellik Mühendisliği)/feature_engineering/datasets/diabetes.csv")
df.head()
